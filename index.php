...
// user not able to go back to login page unless user logout
$g_user_role = $session_class->getValue('role_id');
include "redirect.php"; // check user role

// Token
$csrf = new CSRF($session_class); 

// LOGIN ATTEMP
// user login attemp is not functional yet - neru
...
<body data-layout="detached">
	...
	<!-- LOGIN HEADER -->
	<?php include DOMAIN_PATH."/app/global/login_header.php"; ?>
	<!-- END * LOGIN HEADER -->


    <!-- HEADER -->
    <div class="container-fluid active">
        <div class="wrapper in" style="margin-top: 5vw;">
            <!-- BEGIN CONTENT -->
            <!-- SIDEBAR -->
                                    ...
                                    <div class="card-body">
										...
										<h3 id="log_title">LOGIN</h3>
											<div class="row">
												...
												<div class="form-group col-xs-12 col-sm-12 col-lg-12">
													<button type="submit" id="btn_submit" name="submit" value="login" class="btn btn-primary" style="padding-right: 40px; padding-left: 40px;">LOGIN</button> 
												</div>
												 <?php echo $csrf->input('token_login_admin','token_login_admin_forms',3600,1); ?>
											 </div>
										</form>
										<!-- End FORM -->
